  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-darkLuxuryPurple via-black to-darkLuxuryPurple min-h-[80vh] relative mx-auto flex flex-col justify-center items-center text-center">
        <div className="flex flex-col justify-center items-center mx-auto px-10 py-20 rounded-xl bg-black/50 backdrop-blur-sm border border-red-500/20 shadow-2xl max-w-md">
          {/* 500 Number */}
          <div className="text-8xl md:text-9xl font-bold text-red-500 mb-4 opacity-80">
            500
          </div>
